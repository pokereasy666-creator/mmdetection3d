...
from .dgf_fuser import DGFFuser  # [module-C/DGF] DepthFusion arXiv:2505.07398
...
__all__ = [
    'BEVFusion', 'TransFusionHead', 'ConvFuser', 'DGFFuser', 'ImageAug3D',
    'GridMask', 'GeneralizedLSSFPN', 'HungarianAssigner3D', 'BBoxBEVL1Cost',
    'IoU3DCost', 'HeuristicAssigner3D', 'DepthLSSTransform', 'LSSTransform',
